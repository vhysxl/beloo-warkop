import { Card, CardBody, Image, Accordion, AccordionItem, Popover, PopoverTrigger, PopoverContent, Button } from "@nextui-org/react";
...
export default function TentangKamiBeloo() {
  return (
    <>
      ...
      >
        <h1 className="text-3xl font-bold text-center mb-8 sm:mb-10 md:mb-12">Tentang Beloo Warkop</h1>
            ...
            <CardBody>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 md:gap-8">
                <div className="flex items-center space-x-2">
                  ...
                  <span>Jl. Pangeran Jayakarta, Harapan Mulya, Kecamatan Medan Satria, Kota Bekasi, Jawa Barat 17143</span>
                </div>
                <div className="flex items-center space-x-2">
              ...
              <div className="mt-4 flex space-x-4">
                <Popover placement="bottom">
                  <PopoverTrigger>
                    <Button color="primary" className="bg-[#C5A572]">
                      Ikuti Kami
                    </Button>
                  </PopoverTrigger>
                  <PopoverContent>
